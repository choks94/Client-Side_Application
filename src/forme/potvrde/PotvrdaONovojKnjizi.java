 ...
 * @author STEFAN94
 */
public class PotvrdaONovojKnjizi extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public PotvrdaONovojKnjizi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.getContentPane().setBackground(java.awt.Color.lightGray);
        glavnaForma = (GlavnaForma) this.getParent();
        novaKnjiga = glavnaForma.getNovaKnjiga();
        lblInfo.setText("Da li ste sigurni da zelite da unesete novu knjigu: " + novaKnjiga.getNaziv() + "?");
    ...
    private void btnPotvrdiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPotvrdiActionPerformed
        ...
        kz.setParametar(novaKnjiga);
        kz.setOperacija(Operacija.UNESI_KNJIGU);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PotvrdaONovojKnjizi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PotvrdaONovojKnjizi dialog = new PotvrdaONovojKnjizi(new javax.swing.JFrame(), true);
