 ...
 * @author STEFAN94
 */
public class PotvrdaOIzmeniClana extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public PotvrdaOIzmeniClana(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        lblInfo.setText("Da li ste sigurni da zelite da izmenite podatke o clanu: " + clanZaBrisanje.getIme() + " " + clanZaBrisanje.getPrezime() + "?");
    ...
    private void initComponents() {
        ...
        setTitle("Izmeni podatke o clanu?");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(lblInfo, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void btnPotvrdiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPotvrdiActionPerformed
        ...
        ClanoviForma clanoviForma = (ClanoviForma) this.getParent();
        Clan izmenjeniClan = clanoviForma.getIzmenjenClan();

        KlijentskiZahtev klijentskiZahtev = new KlijentskiZahtev();
        java.sql.Date datRodj = new java.sql.Date(izmenjeniClan.getDatumRodjenja().getTime());
        izmenjeniClan.setDatumRodjenja(datRodj);
        klijentskiZahtev.setParametar(izmenjeniClan);
        klijentskiZahtev.setOperacija(Operacija.IZMENI_CLANA);
        ...
        clanoviForma.getBtnZaduzenja().setEnabled(false);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PotvrdaOIzmeniClana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PotvrdaOIzmeniClana dialog = new PotvrdaOIzmeniClana(new javax.swing.JFrame(), true);
